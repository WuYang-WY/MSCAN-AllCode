...
class DCCANShareTwoLevelPlusWithSkipConcat(nn.Module):

    def __init__(self):
        super(DCCANShareTwoLevelPlusWithSkipConcat, self).__init__()
        self.encode1 = Encoder(inchannel=6, ksize=3, spp=(1,))
    ...
    def encode_decode_level(self, x, last_scale_out, scale):
        ...
        enc1_4, enc2_4, tmp = self.encode1(torch.cat([x, residual2], dim=1))
